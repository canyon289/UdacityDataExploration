...
```
It's a lot easier to see now. Looks like median of the donations is around 80 
dollars and most of the donations are between 10 and a 100 dollars.  
...
```
Another point of curiosity is how contributions trend over time. Plotting the sumb of contribution we can see a very interesting cycle. For the 2012 election we can see the sum of the donations starting low in 2011, then quickly rising until election day where they seem to completely cease. Between the end of 2012 until the start of 2015 there is almost not activity. However we can see the start of the trend again in 2015.
